...
public class EscapeUtils {
	...
	public EscapeUtils() {
		...
		BCD8421Operator bcd8421Operator = new BCD8421Operator();
	}
	...
	private int generateMsgBodyProps(int msgLen, int enctyptionType, boolean isSubPackage, int reversed_14_15) {
		// [ 0-9 ] 0000,0011,1111,1111(3FF)(消息体长度)
		// [10-12] 0001,1100,0000,0000(1C00)(加密类型)
		// [ 13_ ] 0010,0000,0000,0000(2000)(是否有子包)
		// [14-15] 1100,0000,0000,0000(C000)(保留位)
		if (msgLen >= 1024) {
			System.out.println("The max value of msgLen is 1023, but {} ." + msgLen);
		}
	...
	private byte[] generateMsgHeader(String phone, int msgType, byte[] body, int msgBodyProps, int flowId)
			throws Exception {
		ByteArrayOutputStream baos = null;
		try {
			baos = new ByteArrayOutputStream();
			...
			// 3. 终端手机号 bcd[6]
			baos.write(BCD8421Operator.str2Bcd(phone));
